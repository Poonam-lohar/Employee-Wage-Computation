...
class EmpWage {
    ...
    public static void main(String args[]) {
        ...
        employeeWageComputation.addCompany("Microsoft", 4, 10, 100);
        employeeWageComputation.addCompany("Google", 5, 20, 170);
        employeeWageComputation.addCompany("Apple", 9, 30, 70);
